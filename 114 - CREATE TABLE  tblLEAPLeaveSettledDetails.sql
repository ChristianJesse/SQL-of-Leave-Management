...
-- =========================================
-- Check/Create tblLEAPLeaveSettledDetails
-- =========================================
DECLARE @TableName SYSNAME = 'tblLEAPLeaveSettledDetails';
...
BEGIN
    CREATE TABLE dbo.tblLEAPLeaveSettledDetails
    (
        SID         INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
        LPHID       VARCHAR(10) NULL,
        IDNumber    VARCHAR(10) NULL,
        SDStatus    VARCHAR(55) NULL,
...
N'Records of leave settlement transactions per employee and leave period.';
...
('SID', N'Primary key of leave settlement details.'),
('LPHID', N'Foreign key reference to leave period details.'),
('IDNumber', N'Employee ID number.'),
('SDStatus', N'Settlement status of the record.'),
('Description', N'Detailed description of settlement.'),
('SettledBy', N'User who settled the leave record.'),
('DTSetteled', N'Date and time when the record was settled.');
