...
N'Maintains list of biometric devices/servers used for employee attendance logging.';
...
('ServerID', N'Primary key of biometric server.'),
('IPAddress', N'IP address of biometric device/server.'),
('Port', N'Network port used by the biometric server.'),
('Office', N'Office/location assigned to this server.'),
('Description', N'Additional details about the biometric server.');
