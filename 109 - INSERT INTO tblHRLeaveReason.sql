...
values	('192.168.3.46','4370','WTO' ,'WTO Biometric Server'),
		('192.168.1.40','4370','FCIE','FCIE Biometric Server'),
		('192.168.1.204','4370','JYC','JYC Biometric Server'),
		('192.168.3.61','4370','Test','Test server')
